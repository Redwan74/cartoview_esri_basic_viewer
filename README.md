...
=====================
general purpose app for displaying a web map and configuring a variety of tools. This app offers a clean, simple interface that accentuates the web map and includes a toolbar and floating panel. Built on ArcGIS app template and requires ArcGIS Feature Server App
